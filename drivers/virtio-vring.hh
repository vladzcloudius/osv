...
TRACEPOINT(trace_vring_get_buf_finalize, "vring=%p: _used_ring_host_head %d", void*, int);
TRACEPOINT(trace_vring_update_used_event, "vring=%p: _used_ring_host_head %d",void*, int);
