...
public:
    ...
    void update(u64 new_work) {
        ...
        //
        // We will check the amount of time that has passed every
        // "checkpoints_thresh" iterations. If "time_thresh_ms" time has passed
        // we'll check the average work rate and update thread's priority
        // appropriately.
        //
